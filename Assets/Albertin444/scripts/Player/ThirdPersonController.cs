...
{
    private CharacterInput playerActionsAsset;
    ...
    private void Awake()
    {
        ...
        playerActionsAsset = new CharacterInput();
    ...
    private void FixedUpdate()
    {
        ...
        {
            rb.velocity = new Vector3(rb.velocity.x, rb.velocity.y - (fallMultiplier * Time.fixedDeltaTime), rb.velocity.z);
